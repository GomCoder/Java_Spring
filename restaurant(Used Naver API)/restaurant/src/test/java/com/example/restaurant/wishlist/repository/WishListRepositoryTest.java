...
public class WishListRepositoryTest {
    ...
    private WishListEntity create() { //저장
    ...
    @Test
    public void findByIdTest() { //특정한 index를 가져오는지 Test
        var wishListEntity = create();
    ...
    @Test
    public void deleteTest() { //삭제 Test
        var wishListEntity = create();
        wishListRepository.save(wishListEntity);
    ...
    @Test
    public void listAllTest() { //전체 저장 확인 Test
